        ...
        <div class="row">
          ...
          <div class="col-md-4">
              ...
              <li class="list-group-item">Record: <b><label for="yearly">Yearly:</label>&nbsp;&nbsp;<input type="checkbox" value="yearly" name="yearly" id="yearly" /></b>&nbsp;<b><label for="termly">Termly:</label> &nbsp;&nbsp;<input type="checkbox" value="termly" name="termly" id="termly" checked="checked" /></b></li>
                  ...
                  <li class="list-group-item">Exam:  &nbsp;&nbsp;<label for="allExam">All</label>&nbsp;&nbsp;<input type="radio" id="allExam" name="term" value="allExam" class="examSelected" /> &nbsp;&nbsp;<label for="bot">B.O.T</label>&nbsp;&nbsp;<input type="radio" name="bot" id="bot" value="BOT" class="examSelected" <?php echo ((strtolower($exam_type_title) == 'bot')? 'checked' : ''); ?> />&nbsp;&nbsp;<label for="eot">E.O.T</label>&nbsp;&nbsp;<input type="radio" name="eot" class="examSelected" value="EOT" id="eot" <?php echo ((strtolower($exam_type_title) == 'eot')? 'checked' : ''); ?> />&nbsp;&nbsp;<label for="mot">M.O.T</label>&nbsp;&nbsp;<input type="radio" name="mot" class="examSelected" value="MOT" id="mot" <?php echo ((strtolower($exam_type_title) == 'mot')? 'checked' : ''); ?> /></li>
              </ul>
          </div>
